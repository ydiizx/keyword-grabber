...
def get_keyword(keyword=None, language="en", limit=500):
    ...
    headers = {'Accept': 'application/json, text/plain, */*',
               'Authorization': "Bearer app#cognito__50a8296df3fb84acd56da093bf5e1f81900a9cd0",
               "X-Transaction-ID": "fb4d7bbd7cac4bc6a5fe77b60f6de5ff"
               }
    ...
    while len(result) <= limit:
        if counter == 0:
            ...
            url_2 = "https://app.neilpatel.com/api/match_keywords?keyword={}&locId={}&language=en&sortBy=searchVolume&sortMode=desc&limit={}&nextKey={}"
